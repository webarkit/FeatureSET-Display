//#region build/arfset_ES6_wasm.js
var e = (() => {
	var e = import.meta.url;
	return (function(t = {}) {
		var n, r = Object.assign({}, t), i, a, o = new Promise((e, t) => {
			i = e, a = t;
		}), s = !0, c = !1, l = Object.assign({}, r), u = "./this.program", d = (e, t) => {
			throw t;
		}, f = "", p, ee, te;
		(s || c) && (c ? f = self.location.href : typeof document < "u" && document.currentScript && (f = document.currentScript.src), e && (f = e), f = f.startsWith("blob:") ? "" : f.substr(0, f.replace(/[?#].*/, "").lastIndexOf("/") + 1), p = (e) => {
		...
		var m = r.print || console.log.bind(console), h = r.printErr || console.error.bind(console);
		Object.assign(r, l), l = null, r.arguments && r.arguments, r.thisProgram && (u = r.thisProgram), r.quit && (d = r.quit);
		var ne;
		...
		function ie(e) {
			if (Ee(e)) return re(e.slice(Te.length));
		}
		var ae, oe = !1, g, _, v, se, y, b, ce, le;
		function ue() {
			var e = ae.buffer;
			r.HEAP8 = g = new Int8Array(e), r.HEAP16 = v = new Int16Array(e), r.HEAPU8 = _ = new Uint8Array(e), r.HEAPU16 = se = new Uint16Array(e), r.HEAP32 = y = new Int32Array(e), r.HEAPU32 = b = new Uint32Array(e), r.HEAPF32 = ce = new Float32Array(e), r.HEAPF64 = le = new Float64Array(e);
		}
		var de = [], fe = [], pe = [];
		function me() {
			if (r.preRun) for (typeof r.preRun == "function" && (r.preRun = [r.preRun]); r.preRun.length;) _e(r.preRun.shift());
			Ie(de);
		}
		function he() {
			!r.noFSInit && !N.init.initialized && N.init(), N.ignorePermissions = !1, j.init(), Ie(fe);
		}
		function ge() {
			if (r.postRun) for (typeof r.postRun == "function" && (r.postRun = [r.postRun]); r.postRun.length;) ye(r.postRun.shift());
			Ie(pe);
		}
		function _e(e) {
			de.unshift(e);
		...
		var x = 0, be = null, S = null;
		function xe(e) {
			return e;
		}
		function Se(e) {
			x++, r.monitorRunDependencies?.(x);
		}
		function Ce(e) {
			if (x--, r.monitorRunDependencies?.(x), x == 0 && (be !== null && (clearInterval(be), be = null), S)) {
				var t = S;
				S = null, t();
			}
		}
		function we(e) {
			r.onAbort?.(e), e = "Aborted(" + e + ")", h(e), oe = !0, e += ". Build with -sASSERTIONS for more info.";
			var t = new WebAssembly.RuntimeError(e);
			throw a(t), t;
		}
		var Te = "data:application/octet-stream;base64,", Ee = (e) => e.startsWith(Te);
		function De() {
		...
		var Oe;
		function ke(e) {
			if (e == Oe && ne) return new Uint8Array(ne);
			var t = ie(e);
			if (t) return t;
			if (te) return te(e);
		...
		function Ae(e) {
			return Promise.resolve().then(() => ke(e));
		}
		function je(e, t, n) {
			return Ae(e).then((e) => WebAssembly.instantiate(e, t)).then(n, (e) => {
				h(`failed to asynchronously prepare wasm: ${e}`), we(e);
			});
		}
		function Me(e, t, n, r) {
			return je(t, n, r);
		...
		function Pe() {
			var e = Ne();
			function t(e, t) {
				return Z = e.exports, ae = Z.T, ue(), rn = Z.X, ve(Z.U), Ce("wasm-instantiate"), Z;
			}
			Se("wasm-instantiate");
			function n(e) {
				t(e.instance);
			...
			if (r.instantiateWasm) try {
				...
				h(`Module.instantiateWasm callback failed with error: ${e}`), a(e);
			}
			return Oe ||= De(), Me(ne, Oe, e, n).catch(a), {};
		}
		var C, w;
		function Fe(e) {
		...
		}, Le = r.noExitRuntime || !0, T = (e) => Tr(e), E = () => Er();
		class Re {
			constructor(e) {
			...
			get_exception_ptr() {
				if (Dr(this.get_type())) return b[this.excPtr >> 2];
				var e = this.get_adjusted_ptr();
				return e === 0 ? this.excPtr : e;
			}
		}
		var ze = 0, Be = 0, Ve = (e, t, n) => {
			throw new Re(e).init(t, n), ze = e, Be++, ze;
		};
		function He() {
			var e = y[P.varargs >> 2];
		...
		var D = He, O = {
			...
			normalize: (e) => {
				var t = O.isAbs(e), n = e.substr(-1) === "/";
				return e = O.normalizeArray(e.split("/").filter((e) => !!e), !t).join("/"), !e && !t && (e = "."), e && n && (e += "/"), (t ? "/" : "") + e;
			},
			dirname: (e) => {
				var t = O.splitPath(e), n = t[0], r = t[1];
			...
			resolve: (...e) => {
				...
				return t = O.normalizeArray(t.split("/").filter((e) => !!e), !n).join("/"), (n ? "/" : "") + t || ".";
			},
			relative: (e, t) => {
		...
		}, Ge = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, A = (e, t, n) => {
			for (var r = t + n, i = t; e[i] && !(i >= r);) ++i;
			if (i - t > 16 && e.buffer && Ge) return Ge.decode(e.subarray(t, i));
			for (var a = ""; t < i;) {
				var o = e[t++];
				if (!(o & 128)) {
		...
		function Ye(e, t, n) {
			var r = n > 0 ? n : qe(e) + 1, i = Array(r), a = Je(e, i, 0, i.length);
		...
		var Xe = () => {
			...
			stream_ops: {
				...
				read(e, t, n, r, i) {
					...
					for (var a = 0, o = 0; o < r; o++) {
						...
						if (s === void 0 && a === 0) throw new N.ErrnoError(6);
						if (s == null) break;
						a++, t[n + o] = s;
					}
			...
			default_tty_ops: {
				...
				put_char(e, t) {
					t === null || t === 10 ? (m(A(e.output, 0)), e.output = []) : t != 0 && e.output.push(t);
				},
				fsync(e) {
					e.output && e.output.length > 0 && (m(A(e.output, 0)), e.output = []);
				},
				ioctl_tcgets(e) {
					return {
						c_iflag: 25856,
			...
			default_tty1_ops: {
				put_char(e, t) {
					t === null || t === 10 ? (h(A(e.output, 0)), e.output = []) : t != 0 && e.output.push(t);
				},
				fsync(e) {
					e.output && e.output.length > 0 && (h(A(e.output, 0)), e.output = []);
				}
			}
		}, Ze = (e) => {
			we();
			...
			createNode(e, t, n, r) {
				if (N.isBlkdev(n) || N.isFIFO(n)) throw new N.ErrnoError(63);
				M.ops_table ||= {
					dir: {
						node: {
			...
			node_ops: {
				getattr(e) {
					var t = {};
					return t.dev = N.isChrdev(e.mode) ? e.id : 1, t.ino = e.id, t.mode = e.mode, t.nlink = 1, t.uid = 0, t.gid = 0, t.rdev = e.rdev, N.isDir(e.mode) ? t.size = 4096 : N.isFile(e.mode) ? t.size = e.usedBytes : N.isLink(e.mode) ? t.size = e.link.length : t.size = 0, t.atime = new Date(e.timestamp), t.mtime = new Date(e.timestamp), t.ctime = new Date(e.timestamp), t.blksize = 4096, t.blocks = Math.ceil(t.size / t.blksize), t;
				},
				setattr(e, t) {
					t.mode !== void 0 && (e.mode = t.mode), t.timestamp !== void 0 && (e.timestamp = t.timestamp), t.size !== void 0 && M.resizeFileStorage(e, t.size);
				},
				lookup(e, t) {
					throw N.genericErrors[44];
				},
				mknod(e, t, n, r) {
					return M.createNode(e, t, n, r);
				},
				rename(e, t, n) {
					if (N.isDir(e.mode)) {
						var r;
						...
						if (r) for (var i in r.contents) throw new N.ErrnoError(55);
					}
				...
				rmdir(e, t) {
					for (var n in N.lookupNode(e, t).contents) throw new N.ErrnoError(55);
					delete e.contents[t], e.timestamp = Date.now();
				},
				readdir(e) {
					var t = [".", ".."];
				...
				symlink(e, t, n) {
					var r = M.createNode(e, t, 41471, 0);
					return r.link = n, r;
				},
				readlink(e) {
			...
			stream_ops: {
				...
				write(e, t, n, r, i, a) {
					if (t.buffer === g.buffer && (a = !1), !r) return 0;
					var o = e.node;
					...
					if (M.expandFileStorage(o, i + r), o.contents.subarray && t.subarray) o.contents.set(t.subarray(n, n + r), i);
					else for (var s = 0; s < r; s++) o.contents[i + s] = t[n + s];
					return o.usedBytes = Math.max(o.usedBytes, i + r), r;
				},
				llseek(e, t, n) {
					var r = t;
					if (n === 1 ? r += e.position : n === 2 && N.isFile(e.node.mode) && (r += e.node.usedBytes), r < 0) throw new N.ErrnoError(28);
					return r;
				},
				allocate(e, t, n) {
					M.expandFileStorage(e.node, t + n), e.node.usedBytes = Math.max(e.node.usedBytes, t + n);
				},
				mmap(e, t, n, r, i) {
					if (!N.isFile(e.node.mode)) throw new N.ErrnoError(43);
					var a, o, s = e.node.contents;
					if (!(i & 2) && s.buffer === g.buffer) o = !1, a = s.byteOffset;
					else {
						if ((n > 0 || n + t < s.length) && (s = s.subarray ? s.subarray(n, n + t) : Array.prototype.slice.call(s, n, n + t)), o = !0, a = Ze(t), !a) throw new N.ErrnoError(48);
						g.set(s, a);
					}
					return {
						ptr: a,
				...
				msync(e, t, n, r, i) {
					return M.stream_ops.write(e, t, 0, r, n, !1), 0;
				}
			}
		}, Qe = (e, t, n, r) => {
			var i = r ? "" : xe(`al ${e}`);
			ee(e, (e) => {
				t(new Uint8Array(e)), i && Ce(i);
			}, (t) => {
				if (n) n();
				else throw `Loading data file "${e}" failed.`;
			}), i && Se(i);
		}, $e = (e, t, n, r, i, a) => {
			N.createDataFile(e, t, n, r, i, a);
		}, et = r.preloadPlugins || [], tt = (e, t, n, r) => {
			typeof Browser < "u" && Browser.init();
			var i = !1;
			return et.forEach((a) => {
				i || a.canHandle(t) && (a.handle(e, t, n, r), i = !0);
			}), i;
		}, nt = (e, t, n, r, i, a, o, s, c, l) => {
			var u = t ? k.resolve(O.join2(e, t)) : e, d = xe(`cp ${u}`);
			function f(n) {
				function f(n) {
					l?.(), s || $e(e, t, n, r, i, c), a?.(), Ce(d);
				}
				tt(n, u, f, () => {
					o?.(), Ce(d);
				}) || f(n);
			}
			Se(d), typeof n == "string" ? Qe(n, f, o) : f(n);
		}, rt = (e) => {
			var t = {
				r: 0,
				"r+": 2,
			...
			FSNode: class {
				constructor(e, t, n, r) {
					e ||= this, this.parent = e, this.mount = e.mount, this.mounted = null, this.id = N.nextInode++, this.name = t, this.mode = n, this.node_ops = {}, this.stream_ops = {}, this.rdev = r, this.readMode = 365, this.writeMode = 146;
				}
				get read() {
			...
			lookupPath(e, t = {}) {
				...
				if (t = Object.assign({
					follow_mount: !0,
					recurse_count: 0
				}, t), t.recurse_count > 8) throw new N.ErrnoError(32);
				for (var n = e.split("/").filter((e) => !!e), r = N.root, i = "/", a = 0; a < n.length; a++) {
					var o = a === n.length - 1;
					if (o && t.parent) break;
					if (r = N.lookupNode(r, n[a]), i = O.join2(i, n[a]), N.isMountpoint(r) && (!o || o && t.follow_mount) && (r = r.mounted.root), !o || t.follow) for (var s = 0; N.isLink(r.mode);) {
						var c = N.readlink(i);
						if (i = k.resolve(O.dirname(i), c), r = N.lookupPath(i, { recurse_count: t.recurse_count + 1 }).node, s++ > 40) throw new N.ErrnoError(32);
					}
				}
				return {
					path: i,
			...
			hashName(e, t) {
				...
				return (e + n >>> 0) % N.nameTable.length;
			},
			hashAddNode(e) {
			...
			hashRemoveNode(e) {
				...
				else for (var n = N.nameTable[t]; n;) {
					if (n.name_next === e) {
			...
			lookupNode(e, t) {
				var n = N.mayLookup(e);
				if (n) throw new N.ErrnoError(n);
				for (var r = N.hashName(e.id, t), i = N.nameTable[r]; i; i = i.name_next) {
					var a = i.name;
			...
			mayLookup(e) {
				return N.isDir(e.mode) ? N.nodePermissions(e, "x") || (e.node_ops.lookup ? 0 : 2) : 54;
			},
			mayCreate(e, t) {
				try {
					return N.lookupNode(e, t), 20;
				} catch {}
			...
			mayDelete(e, t, n) {
				...
				if (n) {
					...
					if (N.isRoot(r) || N.getPath(r) === N.cwd()) return 10;
				} else if (N.isDir(r.mode)) return 31;
				return 0;
			},
			mayOpen(e, t) {
				return e ? N.isLink(e.mode) ? 32 : N.isDir(e.mode) && (N.flagsToPermissionString(t) !== "r" || t & 512) ? 31 : N.nodePermissions(e, N.flagsToPermissionString(t)) : 44;
			},
			MAX_OPEN_FDS: 4096,
			nextfd() {
			...
			dupStream(e, t = -1) {
				var n = N.createStream(e, t);
				return n.stream_ops?.dup?.(n), n;
			},
			chrdev_stream_ops: {
				open(e) {
					e.stream_ops = N.getDevice(e.node.rdev).stream_ops, e.stream_ops.open?.(e);
				},
				llseek() {
			...
			syncfs(e, t) {
				typeof e == "function" && (t = e, e = !1), N.syncFSRequests++, N.syncFSRequests > 1 && h(`warning: ${N.syncFSRequests} FS.syncfs operations in flight at once, probably just doing extra work`);
				var n = N.getMounts(N.root.mount), r = 0;
				function i(e) {
					return N.syncFSRequests--, t(e);
				}
				function a(e) {
			...
			mount(e, t, n) {
				var r = n === "/", i = !n, a;
				if (r && N.root) throw new N.ErrnoError(10);
				if (!r && !i) {
					var o = N.lookupPath(n, { follow_mount: !1 });
					if (n = o.path, a = o.node, N.isMountpoint(a)) throw new N.ErrnoError(10);
				...
				return c.mount = s, s.root = c, r ? N.root = c : a && (a.mounted = s, a.mount && a.mount.mounts.push(s)), c;
			},
			unmount(e) {
				var t = N.lookupPath(e, { follow_mount: !1 });
				if (!N.isMountpoint(t.node)) throw new N.ErrnoError(28);
				var n = t.node, r = n.mounted, i = N.getMounts(r);
				Object.keys(N.nameTable).forEach((e) => {
					for (var t = N.nameTable[e]; t;) {
						var n = t.name_next;
						i.includes(t.mount) && N.destroyNode(t), t = n;
					}
				}), n.mounted = null;
			...
			mknod(e, t, n) {
				var r = N.lookupPath(e, { parent: !0 }).node, i = O.basename(e);
				if (!i || i === "." || i === "..") throw new N.ErrnoError(28);
				var a = N.mayCreate(r, i);
				if (a) throw new N.ErrnoError(a);
				if (!r.node_ops.mknod) throw new N.ErrnoError(63);
				return r.node_ops.mknod(r, i, t, n);
			},
			create(e, t) {
				return t = t === void 0 ? 438 : t, t &= 4095, t |= 32768, N.mknod(e, t, 0);
			},
			mkdir(e, t) {
				return t = t === void 0 ? 511 : t, t &= 1023, t |= 16384, N.mknod(e, t, 0);
			},
			mkdirTree(e, t) {
			...
			mkdev(e, t, n) {
				return n === void 0 && (n = t, t = 438), t |= 8192, N.mknod(e, t, n);
			},
			symlink(e, t) {
				if (!k.resolve(e)) throw new N.ErrnoError(44);
				var n = N.lookupPath(t, { parent: !0 }).node;
				if (!n) throw new N.ErrnoError(44);
				var r = O.basename(t), i = N.mayCreate(n, r);
				if (i) throw new N.ErrnoError(i);
				if (!n.node_ops.symlink) throw new N.ErrnoError(63);
				return n.node_ops.symlink(n, r, e);
			},
			rename(e, t) {
				var n = O.dirname(e), r = O.dirname(t), i = O.basename(e), a = O.basename(t), o = N.lookupPath(e, { parent: !0 }), s = o.node, c;
				if (o = N.lookupPath(t, { parent: !0 }), c = o.node, !s || !c) throw new N.ErrnoError(44);
				if (s.mount !== c.mount) throw new N.ErrnoError(75);
				var l = N.lookupNode(s, i), u = k.relative(e, r);
				if (u.charAt(0) !== ".") throw new N.ErrnoError(28);
				if (u = k.relative(t, n), u.charAt(0) !== ".") throw new N.ErrnoError(55);
				var d;
				try {
					d = N.lookupNode(c, a);
				} catch {}
				if (l !== d) {
					var f = N.isDir(l.mode), p = N.mayDelete(s, i, f);
					if (p || (p = d ? N.mayDelete(c, a, f) : N.mayCreate(c, a), p)) throw new N.ErrnoError(p);
					if (!s.node_ops.rename) throw new N.ErrnoError(63);
					if (N.isMountpoint(l) || d && N.isMountpoint(d)) throw new N.ErrnoError(10);
					if (c !== s && (p = N.nodePermissions(s, "w"), p)) throw new N.ErrnoError(p);
					N.hashRemoveNode(l);
					try {
			...
			rmdir(e) {
				var t = N.lookupPath(e, { parent: !0 }).node, n = O.basename(e), r = N.lookupNode(t, n), i = N.mayDelete(t, n, !0);
				if (i) throw new N.ErrnoError(i);
				if (!t.node_ops.rmdir) throw new N.ErrnoError(63);
				if (N.isMountpoint(r)) throw new N.ErrnoError(10);
				t.node_ops.rmdir(t, n), N.destroyNode(r);
			},
			readdir(e) {
				var t = N.lookupPath(e, { follow: !0 }).node;
				if (!t.node_ops.readdir) throw new N.ErrnoError(54);
				return t.node_ops.readdir(t);
			},
			unlink(e) {
				var t = N.lookupPath(e, { parent: !0 }).node;
				if (!t) throw new N.ErrnoError(44);
				var n = O.basename(e), r = N.lookupNode(t, n), i = N.mayDelete(t, n, !1);
				if (i) throw new N.ErrnoError(i);
				if (!t.node_ops.unlink) throw new N.ErrnoError(63);
				if (N.isMountpoint(r)) throw new N.ErrnoError(10);
				t.node_ops.unlink(t, n), N.destroyNode(r);
			},
			readlink(e) {
				var t = N.lookupPath(e).node;
				if (!t) throw new N.ErrnoError(44);
				if (!t.node_ops.readlink) throw new N.ErrnoError(28);
				return k.resolve(N.getPath(t.parent), t.node_ops.readlink(t));
			},
			stat(e, t) {
				var n = N.lookupPath(e, { follow: !t }).node;
				if (!n) throw new N.ErrnoError(44);
				if (!n.node_ops.getattr) throw new N.ErrnoError(63);
			...
			chmod(e, t, n) {
				var r = typeof e == "string" ? N.lookupPath(e, { follow: !n }).node : e;
				if (!r.node_ops.setattr) throw new N.ErrnoError(63);
			...
			fchmod(e, t) {
				var n = N.getStreamChecked(e);
				N.chmod(n.node, t);
			},
			chown(e, t, n, r) {
				var i = typeof e == "string" ? N.lookupPath(e, { follow: !r }).node : e;
			...
			truncate(e, t) {
				...
				var n = typeof e == "string" ? N.lookupPath(e, { follow: !0 }).node : e;
				if (!n.node_ops.setattr) throw new N.ErrnoError(63);
				if (N.isDir(n.mode)) throw new N.ErrnoError(31);
				if (!N.isFile(n.mode)) throw new N.ErrnoError(28);
				var r = N.nodePermissions(n, "w");
			...
			ftruncate(e, t) {
				var n = N.getStreamChecked(e);
				if (!(n.flags & 2097155)) throw new N.ErrnoError(28);
				N.truncate(n.node, t);
			},
			utime(e, t, n) {
			...
			open(e, t, n) {
				...
				t = typeof t == "string" ? rt(t) : t, t & 64 ? (n = n === void 0 ? 438 : n, n = n & 4095 | 32768) : n = 0;
				var i;
				if (typeof e == "object") i = e;
				else {
					e = O.normalize(e);
					try {
						i = N.lookupPath(e, { follow: !(t & 131072) }).node;
					} catch {}
				}
				var a = !1;
				if (t & 64) if (i) {
					if (t & 128) throw new N.ErrnoError(20);
				} else i = N.mknod(e, n, 0), a = !0;
				if (!i) throw new N.ErrnoError(44);
				if (N.isChrdev(i.mode) && (t &= -513), t & 65536 && !N.isDir(i.mode)) throw new N.ErrnoError(54);
				if (!a) {
					var o = N.mayOpen(i, t);
					if (o) throw new N.ErrnoError(o);
				}
				t & 512 && !a && N.truncate(i, 0), t &= -131713;
				...
				return s.stream_ops.open && s.stream_ops.open(s), r.logReadFiles && !(t & 1) && (N.readFiles ||= {}, e in N.readFiles || (N.readFiles[e] = 1)), s;
			},
			close(e) {
			...
			llseek(e, t, n) {
				...
				if (n != 0 && n != 1 && n != 2) throw new N.ErrnoError(28);
				return e.position = e.stream_ops.llseek(e, t, n), e.ungotten = [], e.position;
			},
			read(e, t, n, r, i) {
				if (r < 0 || i < 0) throw new N.ErrnoError(28);
				if (N.isClosed(e) || (e.flags & 2097155) == 1) throw new N.ErrnoError(8);
			...
			write(e, t, n, r, i, a) {
				if (r < 0 || i < 0) throw new N.ErrnoError(28);
				if (N.isClosed(e) || !(e.flags & 2097155)) throw new N.ErrnoError(8);
				if (N.isDir(e.node.mode)) throw new N.ErrnoError(31);
			...
			allocate(e, t, n) {
				if (N.isClosed(e)) throw new N.ErrnoError(8);
				if (t < 0 || n <= 0) throw new N.ErrnoError(28);
			...
			mmap(e, t, n, r, i) {
				if (r & 2 && !(i & 2) && (e.flags & 2097155) != 2 || (e.flags & 2097155) == 1) throw new N.ErrnoError(2);
			...
			readFile(e, t = {}) {
				...
				var n, r = N.open(e, t.flags), i = N.stat(e).size, a = new Uint8Array(i);
				return N.read(r, a, 0, i, 0), t.encoding === "utf8" ? n = A(a, 0) : t.encoding === "binary" && (n = a), N.close(r), n;
			},
			writeFile(e, t, n = {}) {
				n.flags = n.flags || 577;
				var r = N.open(e, n.flags, n.mode);
				if (typeof t == "string") {
					var i = new Uint8Array(qe(t) + 1), a = Je(t, i, 0, i.length);
					N.write(r, i, 0, a, void 0, n.canOwn);
				} else if (ArrayBuffer.isView(t)) N.write(r, t, 0, t.byteLength, void 0, n.canOwn);
				else throw Error("Unsupported data type");
				N.close(r);
			},
			cwd: () => N.currentPath,
			chdir(e) {
				var t = N.lookupPath(e, { follow: !0 });
				if (t.node === null) throw new N.ErrnoError(44);
				if (!N.isDir(t.node.mode)) throw new N.ErrnoError(54);
				var n = N.nodePermissions(t.node, "x");
				if (n) throw new N.ErrnoError(n);
			...
			createDefaultDevices() {
				...
				var e = new Uint8Array(1024), t = 0, n = () => (t === 0 && (t = We(e).byteLength), e[--t]);
				N.createDevice("/dev", "random", n), N.createDevice("/dev", "urandom", n), N.mkdir("/dev/shm"), N.mkdir("/dev/shm/tmp");
			},
			createSpecialDirectories() {
				...
				N.mkdir("/proc/self/fd"), N.mount({ mount() {
					...
					return t.node_ops = { lookup(e, t) {
						var n = +t, r = N.getStreamChecked(n), i = {
							parent: null,
			...
			createStandardStreams() {
				r.stdin ? N.createDevice("/dev", "stdin", r.stdin) : N.symlink("/dev/tty", "/dev/stdin"), r.stdout ? N.createDevice("/dev", "stdout", null, r.stdout) : N.symlink("/dev/tty", "/dev/stdout"), r.stderr ? N.createDevice("/dev", "stderr", null, r.stderr) : N.symlink("/dev/tty1", "/dev/stderr"), N.open("/dev/stdin", 0), N.open("/dev/stdout", 1), N.open("/dev/stderr", 1);
			},
			staticInit() {
				[44].forEach((e) => {
					N.genericErrors[e] = new N.ErrnoError(e), N.genericErrors[e].stack = "<generic error, no stack>";
				}), N.nameTable = Array(4096), N.mount(M, {}, "/"), N.createDefaultDirectories(), N.createDefaultDevices(), N.createSpecialDirectories(), N.filesystems = { MEMFS: M };
			},
			init(e, t, n) {
				N.init.initialized = !0, r.stdin = e || r.stdin, r.stdout = t || r.stdout, r.stderr = n || r.stderr, N.createStandardStreams();
			},
			quit() {
			...
			findObject(e, t) {
				var n = N.analyzePath(e, t);
				return n.exists ? n.object : null;
			},
			analyzePath(e, t) {
				try {
					var n = N.lookupPath(e, { follow: !t });
					e = n.path;
				} catch {}
				var r = {
					isRoot: !1,
				...
				try {
					var n = N.lookupPath(e, { parent: !0 });
					r.parentExists = !0, r.parentPath = n.path, r.parentObject = n.node, r.name = O.basename(e), n = N.lookupPath(e, { follow: !t }), r.exists = !0, r.path = n.path, r.object = n.node, r.name = n.node.name, r.isRoot = n.path === "/";
				} catch (e) {
					r.error = e.errno;
				}
				return r;
			...
			createFile(e, t, n, r, i) {
				var a = O.join2(typeof e == "string" ? e : N.getPath(e), t), o = it(r, i);
				return N.create(a, o);
			},
			createDataFile(e, t, n, r, i, a) {
				var o = t;
				e && (e = typeof e == "string" ? e : N.getPath(e), o = t ? O.join2(e, t) : e);
				var s = it(r, i), c = N.create(o, s);
				if (n) {
					if (typeof n == "string") {
					...
					N.chmod(c, s | 146);
					var f = N.open(c, 577);
					N.write(f, n, 0, n.length, 0, a), N.close(f), N.chmod(c, s);
				}
			},
			createDevice(e, t, n, r) {
				var i = O.join2(typeof e == "string" ? e : N.getPath(e), t), a = it(!!n, !!r);
				...
				return N.registerDevice(o, {
					...
					read(e, t, r, i, a) {
						for (var o = 0, s = 0; s < i; s++) {
							...
							if (c === void 0 && o === 0) throw new N.ErrnoError(6);
							if (c == null) break;
							o++, t[r + s] = c;
						}
			...
			forceLoadFile(e) {
				...
				if (p) try {
					e.contents = Ye(p(e.url), !0), e.usedBytes = e.contents.length;
				} catch {
					throw new N.ErrnoError(29);
				}
			...
			createLazyFile(e, t, n, r, i) {
				class a {
					...
					cacheLength() {
						...
						var s = (e, r) => {
							...
							return i.response === void 0 ? Ye(i.responseText || "", !0) : new Uint8Array(i.response || []);
						}, c = this;
						c.setDataGetter((e) => {
							var n = e * o, r = (e + 1) * o - 1;
				...
				return l.read = (e, t, n, r, i) => (N.forceLoadFile(s), u(e, t, n, r, i)), l.mmap = (e, t, n, r, i) => {
					N.forceLoadFile(s);
					var a = Ze(t);
					if (!a) throw new N.ErrnoError(48);
					return u(e, g, a, t, n), {
						ptr: a,
						allocated: !0
					};
			...
			DEFAULT_POLLMASK: 5,
			calculateAt(e, t, n) {
				if (O.isAbs(t)) return t;
				var r = e === -100 ? N.cwd() : P.getStreamFromFD(e).path;
				if (t.length == 0) {
					if (!n) throw new N.ErrnoError(44);
					return r;
				}
		...
		function ot(e, t, n) {
			...
			try {
				...
				if (N === void 0 || e.name !== "ErrnoError") throw e;
				return -e.errno;
			}
		}
		function st(e, t, n) {
				...
				switch (t) {
					...
					case 21505:
						...
						if (r.tty.ops.ioctl_tcgets) {
							var i = r.tty.ops.ioctl_tcgets(r), a = D();
							y[a >> 2] = i.c_iflag || 0, y[a + 4 >> 2] = i.c_oflag || 0, y[a + 8 >> 2] = i.c_cflag || 0, y[a + 12 >> 2] = i.c_lflag || 0;
							for (var o = 0; o < 32; o++) g[a + o + 17] = i.c_cc[o] || 0;
							return 0;
						}
						return 0;
					case 21510:
					...
					case 21508:
						...
						if (r.tty.ops.ioctl_tcsets) {
							for (var a = D(), s = y[a >> 2], c = y[a + 4 >> 2], l = y[a + 8 >> 2], u = y[a + 12 >> 2], d = [], o = 0; o < 32; o++) d.push(g[a + o + 17]);
					...
					case 21531:
						var a = D();
						return N.ioctl(r, t, a);
					case 21523:
						if (!r.tty) return -59;
						if (r.tty.ops.ioctl_tiocgwinsz) {
							var f = r.tty.ops.ioctl_tiocgwinsz(r.tty), a = D();
							v[a >> 1] = f[0], v[a + 2 >> 1] = f[1];
						}
						return 0;
		...
		function ct(e, t, n, r) {
			P.varargs = r;
			try {
				t = P.getStr(t), t = P.calculateAt(e, t);
				var i = r ? He() : 0;
				return N.open(t, n, i).fd;
			} catch (e) {
				if (N === void 0 || e.name !== "ErrnoError") throw e;
				return -e.errno;
			}
		...
		var I = {}, L = {}, ft = {}, pt, mt = (e) => {
			...
			t.forEach((e, t) => {
				L.hasOwnProperty(e) ? i[t] = L[e] : (a.push(e), I.hasOwnProperty(e) || (I[e] = []), I[e].push(() => {
					i[t] = L[e], ++o, o === a.length && r(i);
				}));
			}), a.length === 0 && r(i);
		}, ht = (e) => {
			var t = ut[e];
			...
			R([e], i, (e) => (n.forEach((t, n) => {
				var i = e[n], a = t.getter, o = t.getterContext, s = e[n + r], c = t.setter, l = t.setterContext;
				t.read = (e) => i.fromWireType(a(o, e)), t.write = (e, t) => {
					var n = [];
					c(l, e, s.toWireType(n, t)), dt(n);
				};
			}), [{
				name: t.name,
				fromWireType: (e) => {
			...
			R([e], a, (e) => {
				...
				return i.forEach((t, n) => {
					var r = t.fieldName, o = e[n], s = t.getter, c = t.getterContext, l = e[n + i.length], u = t.setter, d = t.setterContext;
					a[r] = {
						read: (e) => o.fromWireType(s(c, e)),
						write: (e, t) => {
							var n = [];
							u(d, e, l.toWireType(n, t)), dt(n);
						}
					};
				}), [{
					name: t.name,
		...
		function xt(e, t, n = {}) {
			var r = t.name;
			if (e || V(`type "${r}" must have a positive integer typeid pointer`), L.hasOwnProperty(e)) {
				if (n.ignoreDuplicateRegistrations) return;
				V(`Cannot register type '${r}' twice`);
			}
			if (L[e] = t, delete ft[e], I.hasOwnProperty(e)) {
				var i = I[e];
		...
		var U = 8, St = (e, t, n, r) => {
			...
			--e.count.value, e.count.value === 0 && Dt(e);
		}, kt = (e, t, n) => {
			if (t === n) return e;
			if (n.baseClass === void 0) return null;
			var r = kt(e, t, n.baseClass);
			return r === null ? null : n.downcast(r);
		}, At = {}, jt = () => Object.keys(K).length, Mt = () => {
			var e = [];
			for (var t in K) K.hasOwnProperty(t) && e.push(K[t]);
			return e;
		}, W = [], Nt = () => {
			for (; W.length;) {
				var e = W.pop();
			...
			r.getInheritedInstanceCount = jt, r.getLiveInheritedInstances = Mt, r.flushPendingDeletes = Nt, r.setDelayFunction = Pt;
		}, K = {}, It = (e, t) => {
			for (t === void 0 && V("ptr should not be undefined"); e.baseClass;) t = e.upcast(t), e = e.baseClass;
			return t;
		}, Lt = (e, t) => (t = It(e, t), K[t]), Rt = (e, t) => ((!t.ptrType || !t.ptr) && mt("makeClassHandle requires ptr and ptrType"), !!t.smartPtrType != !!t.smartPtr && mt("Both smartPtrType and smartPtr must be specified"), t.count = { value: 1 }, q(Object.create(e, { $$: {
			value: t,
			writable: !0
		} })));
		function zt(e) {
			...
			var n = Lt(this.registeredClass, t);
			if (n !== void 0) {
			...
			function i() {
				return this.isSmartPointer ? Rt(this.registeredClass.instancePrototype, {
					ptrType: this.pointeeType,
					ptr: t,
					smartPtrType: this,
					smartPtr: e
				}) : Rt(this.registeredClass.instancePrototype, {
					ptrType: this,
					ptr: e
				});
			}
			...
			var o = this.isConst ? a.constPointerType : a.pointerType, s = kt(t, this.registeredClass, o.registeredClass);
			return s === null ? i.call(this) : this.isSmartPointer ? Rt(o.registeredClass.instancePrototype, {
				ptrType: o,
				ptr: s,
				smartPtrType: this,
				smartPtr: e
			}) : Rt(o.registeredClass.instancePrototype, {
				ptrType: o,
				ptr: s
			});
		}
		var q = (e) => typeof FinalizationRegistry > "u" ? (q = (e) => e, e) : (Tt = new FinalizationRegistry((e) => {
			Ot(e.$$);
		}), q = (e) => {
			var t = e.$$;
			if (t.smartPtr) {
			...
			Object.assign(Vt.prototype, {
				...
				clone() {
					...
					var e = q(Object.create(Object.getPrototypeOf(this), { $$: { value: Ct(this.$$) } }));
					return e.$$.count.value += 1, e.$$.deleteScheduled = !1, e;
				},
				delete() {
					this.$$.ptr || wt(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && V("Object already scheduled for deletion"), Et(this), Ot(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
				},
				isDeleted() {
					return !this.$$.ptr;
				},
				deleteLater() {
					return this.$$.ptr || wt(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && V("Object already scheduled for deletion"), W.push(this), W.length === 1 && G && G(Nt), this.$$.deleteScheduled = !0, this;
				}
			});
		};
		function Vt() {}
		var Ht = (e, t) => Object.defineProperty(t, "name", { value: e }), Ut = (e, t, n) => {
			...
			r.hasOwnProperty(e) ? ((n === void 0 || r[e].overloadTable !== void 0 && r[e].overloadTable[n] !== void 0) && V(`Cannot register public name '${e}' twice`), Ut(r, e, e), r.hasOwnProperty(n) && V(`Cannot register multiple overloads of a function with the same number of arguments (${n})!`), r[e].overloadTable[n] = t) : (r[e] = t, n !== void 0 && (r[e].numArguments = n));
		}, Gt = 48, Kt = 57, qt = (e) => {
			if (e === void 0) return "_unknown";
			e = e.replace(/[^a-zA-Z0-9_]/g, "$");
			var t = e.charCodeAt(0);
			return t >= Gt && t <= Kt ? `_${e}` : e;
		};
		...
		function Xt(e, t) {
			...
			t.$$ || V(`Cannot pass "${Dn(t)}" as a ${this.name}`), t.$$.ptr || V(`Cannot pass deleted object as a pointer of type ${this.name}`);
			var n = t.$$.ptrType.registeredClass;
			return Yt(t.$$.ptr, n, this.registeredClass);
		}
		function Zt(e, t) {
			var n;
			...
			(!t || !t.$$) && V(`Cannot pass "${Dn(t)}" as a ${this.name}`), t.$$.ptr || V(`Cannot pass deleted object as a pointer of type ${this.name}`), !this.isConst && t.$$.ptrType.isConst && V(`Cannot convert argument of type ${t.$$.smartPtrType ? t.$$.smartPtrType.name : t.$$.ptrType.name} to parameter type ${this.name}`);
			var r = t.$$.ptrType.registeredClass;
			if (n = Yt(t.$$.ptr, r, this.registeredClass), this.isSmartPointer) switch (t.$$.smartPtr === void 0 && V("Passing raw pointer to smart pointer is illegal"), this.sharingPolicy) {
				case 0:
				...
				case 2:
					if (t.$$.smartPtrType === this) n = t.$$.smartPtr;
						...
						var i = t.clone();
						n = this.rawShare(n, wn.toHandle(() => i.delete())), e !== null && e.push(this.rawDestructor, n);
					}
					break;
		...
		function Qt(e, t) {
			if (t === null) return this.isReference && V(`null is not a valid ${this.name}`), 0;
			t.$$ || V(`Cannot pass "${Dn(t)}" as a ${this.name}`), t.$$.ptr || V(`Cannot pass deleted object as a pointer of type ${this.name}`), t.$$.ptrType.isConst && V(`Cannot convert argument of type ${t.$$.ptrType.name} to parameter type ${this.name}`);
			var n = t.$$.ptrType.registeredClass;
			return Yt(t.$$.ptr, n, this.registeredClass);
		}
		var $t = () => {
		...
		function en(e, t, n, r, i, a, o, s, c, l, u) {
			this.name = e, this.registeredClass = t, this.isReference = n, this.isConst = r, this.isSmartPointer = i, this.pointeeType = a, this.sharingPolicy = o, this.rawGetPointee = s, this.rawConstructor = c, this.rawShare = l, this.rawDestructor = u, !i && t.baseClass === void 0 ? r ? (this.toWireType = Xt, this.destructorFunction = null) : (this.toWireType = Qt, this.destructorFunction = null) : this.toWireType = Zt;
		}
		var tn = (e, t, n) => {
			r.hasOwnProperty(e) || mt("Replacing nonexistent public symbol"), r[e].overloadTable !== void 0 && n !== void 0 ? r[e].overloadTable[n] = t : (r[e] = t, r[e].argCount = n);
		}, nn = (e, t, n) => {
			e = e.replace(/p/g, "i");
			var i = r["dynCall_" + e];
			return i(t, ...n);
		}, rn, J = (e) => rn.get(e), an = (e, t, n = []) => e.includes("j") ? nn(e, t, n) : J(t)(...n), on = (e, t) => (...n) => an(e, t, n), Y = (e, t) => {
			e = z(e);
			function n() {
				return e.includes("j") ? on(e, t) : J(t);
			}
			var r = n();
			return typeof r != "function" && V(`unknown function pointer with signature ${e}: ${t}`), r;
		}, sn = (e, t) => {
			var n = Ht(t, function(e) {
			...
			throw t.forEach(i), new cn(`${e}: ` + n.map(ln).join([", "]));
		}, dn = (e, t, n, r, i, a, o, s, c, l, u, d, f) => {
			u = z(u), a = Y(i, a), s &&= Y(o, s), l &&= Y(c, l), f = Y(d, f);
			var p = qt(u);
			Wt(p, function() {
				un(`Cannot construct ${u} due to unbound types`, [r]);
			}), R([
				e,
				t,
				n
				...
				t = t[0];
				var n, i;
				r ? (n = t.registeredClass, i = n.instancePrototype) : i = Vt.prototype;
				var o = Ht(u, function(...e) {
				...
				o.prototype = c;
				var d = new Jt(u, o, c, f, n, a, s, l);
				d.baseClass && (d.baseClass.__derivedClasses ??= [], d.baseClass.__derivedClasses.push(d));
				var ee = new en(u, d, !0, !1, !1), te = new en(u + "*", d, !1, !1, !1), m = new en(u + " const*", d, !1, !0, !1);
				return At[e] = {
					pointerType: te,
					constPointerType: m
				}, tn(p, o), [
		...
		function mn(e, t) {
			...
			var n = Ht(e.name || "unknownFunctionName", function() {});
			n.prototype = e.prototype;
			var r = new n(), i = e.apply(r, t);
			return i instanceof Object ? i : r;
		}
		function hn(e, t, n, r) {
			for (var i = pn(e), a = e.length, o = "", s = "", c = 0; c < a - 2; ++c) o += (c === 0 ? "" : ", ") + "arg" + c, s += (c === 0 ? "" : ", ") + "arg" + c + "Wired";
		...
		function gn(e, t, n, r, i, a) {
			...
			let [f, p] = hn(t, s, l, a);
			return f.push(p), Ht(e, mn(Function, f)(...u));
		}
		var _n = (e, t, n, r, i, a) => {
			var o = fn(t, n);
			i = Y(r, i), R([], [e], (e) => {
				...
				return e.registeredClass.constructor_body[t - 1] = () => {
					un(`Cannot construct ${e.name} due to unbound types`, o);
				}, R([], o, (r) => (r.splice(1, 0, null), e.registeredClass.constructor_body[t - 1] = gn(n, r, null, i, a), [])), [];
			});
		}, vn = (e) => {
			e = e.trim();
			let t = e.indexOf("(");
			return t === -1 ? e : e.substr(0, t);
		}, yn = (e, t, n, r, i, a, o, s, c) => {
			var l = fn(n, r);
			t = z(t), t = vn(t), a = Y(i, a), R([], [e], (e) => {
				e = e[0];
				var r = `${e.name}.${t}`;
				t.startsWith("@@") && (t = Symbol[t.substring(2)]), s && e.registeredClass.pureVirtualFunctions.push(t);
				function i() {
					un(`Cannot call ${r} due to unbound types`, l);
				}
				var u = e.registeredClass.instancePrototype, d = u[t];
				return d === void 0 || d.overloadTable === void 0 && d.className !== e.name && d.argCount === n - 2 ? (i.argCount = n - 2, i.className = e.name, u[t] = i) : (Ut(u, t, r), u[t].overloadTable[n - 2] = i), R([], l, (i) => {
					var s = gn(r, i, e, a, o, c);
					return u[t].overloadTable === void 0 ? (s.argCount = n - 2, u[t] = s) : u[t].overloadTable[n - 2] = s, [];
				}), [];
			});
		}, bn = [], X = [], xn = (e) => {
			e > 9 && --X[e + 1] === 0 && (X[e] = void 0, bn.push(e));
		}, Sn = () => X.length / 2 - 5 - bn.length, Cn = () => {
			X.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), r.count_emval_handles = Sn;
		}, wn = {
			toValue: (e) => (e || V("Cannot use deleted val. handle = " + e), X[e]),
			toHandle: (e) => {
				switch (e) {
			...
			switch (t) {
				case 4: return function(e) {
					return this.fromWireType(ce[e >> 2]);
				};
				case 8: return function(e) {
					return this.fromWireType(le[e >> 3]);
				};
			...
			t = z(t), H(e, {
				...
				toWireType: (e, t) => t,
				argPackAdvance: U,
				readValueFromPointer: On(t, n),
				destructorFunction: null
			});
		}, An = (e, t, n, r, i, a, o) => {
			var s = fn(t, n);
			e = z(e), e = vn(e), i = Y(r, i), Wt(e, function() {
				un(`Cannot call ${e} due to unbound types`, s);
			}, t - 1), R([], s, (n) => {
				var r = [n[0], null].concat(n.slice(1));
				return tn(e, gn(e, r, null, i, a, o), t - 1), [];
			});
		}, jn = (e, t, n) => {
			switch (t) {
				case 1: return n ? (e) => g[e] : (e) => _[e];
				case 2: return n ? (e) => v[e >> 1] : (e) => se[e >> 1];
				case 4: return n ? (e) => y[e >> 2] : (e) => b[e >> 2];
			...
			H(e, {
				...
				toWireType: s,
				argPackAdvance: U,
				readValueFromPointer: jn(t, n, r !== 0),
				destructorFunction: null
			});
		}, Nn = (e, t, n) => {
			var r = [
			...
			function i(e) {
				var t = b[e >> 2], n = b[e + 4 >> 2];
				return new r(g.buffer, n, t);
			}
			n = z(n), H(e, {
				name: n,
				fromWireType: i,
			...
			H(e, {
				...
				fromWireType(e) {
					...
					if (n) for (var a = r, o = 0; o <= t; ++o) {
						...
						for (var u = Array(t), o = 0; o < t; ++o) u[o] = String.fromCharCode(_[r + o]);
						i = u.join("");
					}
					return Q(e), i;
				},
				toWireType(e, t) {
					...
					i || t instanceof Uint8Array || t instanceof Uint8ClampedArray || t instanceof Int8Array || V("Cannot pass non-string to std::string"), r = n && i ? qe(t) : t.length;
					var a = Cr(4 + r + 1), o = a + 4;
					if (b[a >> 2] = r, n && i) Fn(t, o, r + 1);
					else if (i) for (var s = 0; s < r; ++s) {
						var c = t.charCodeAt(s);
						c > 255 && (Q(o), V("String has UTF-16 code units that do not fit in 8 bits")), _[o + s] = c;
					}
					else for (var s = 0; s < r; ++s) _[o + s] = t[s];
		...
		}, Ln = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, Rn = (e, t) => {
			for (var n = e, r = n >> 1, i = r + t / 2; !(r >= i) && se[r];) ++r;
			if (n = r << 1, n - e > 32 && Ln) return Ln.decode(_.subarray(e, n));
			...
			n = z(n);
			var r, i, a, o;
			t === 2 ? (r = Rn, i = zn, o = Bn, a = (e) => se[e >> 1]) : t === 4 && (r = Vn, i = Hn, o = Un, a = (e) => b[e >> 2]), H(e, {
				name: n,
				fromWireType: (e) => {
					for (var n = b[e >> 2], i, o = e + 4, s = 0; s <= n; ++s) {
						var c = e + 4 + s * t;
						if (s == n || a(c) == 0) {
							var l = c - o, u = r(o, l);
				...
				toWireType: (e, r) => {
					...
					var a = o(r), s = Cr(4 + a + t);
					return b[s >> 2] = a / t, i(r, s + 4, a + t), e !== null && e.push(Q, s), s;
				},
				argPackAdvance: U,
				readValueFromPointer: F,
				destructorFunction(e) {
			...
			var n = L[e];
			return n === void 0 && V(`${t} has unknown type ${ln(e)}`), n;
		}, Qn = (e, t) => {
			e = Zn(e, "_emval_take_value");
			var n = e.readValueFromPointer(t);
			return wn.toHandle(n);
		}, $n = (e) => {
			console.error(at(e));
		}, er = (e) => {
			console.warn(at(e));
		}, tr = () => 2147483648, nr = (e) => {
			var t = (e - ae.buffer.byteLength + 65535) / 65536;
			try {
				return ae.grow(t), ue(), 1;
			} catch {}
		}, rr = (e) => {
			var t = _.length;
			e >>>= 0;
			...
			for (var r = (e, t) => e + (t - e % t) % t, i = 1; i <= 4; i *= 2) {
				var a = t * (1 + .2 / i);
				if (a = Math.min(a, e + 100663296), nr(Math.min(n, r(Math.max(e, a), 65536)))) return !0;
			}
			return !1;
		}, ir = {}, ar = () => u || "./this.program", or = () => {
			if (!or.strings) {
				var e = {
					USER: "web_user",
					LOGNAME: "web_user",
			...
			for (var n = 0; n < e.length; ++n) g[t++] = e.charCodeAt(n);
			g[t] = 0;
		}, cr = (e, t) => {
			var n = 0;
			return or().forEach((r, i) => {
				var a = t + n;
				b[e + i * 4 >> 2] = a, sr(r, a), n += r.length + 1;
			}), 0;
		}, lr = (e, t) => {
			var n = or();
			b[e >> 2] = n.length;
		...
		}, ur = 0, dr = () => Le || ur > 0, fr = (e) => {
			dr() || (r.onExit?.(e), oe = !0), d(e, new Fe(e));
		}, pr = (e, t) => {
			fr(e);
		};
		function mr(e) {
			try {
				var t = P.getStreamFromFD(e);
				return N.close(t), 0;
			} catch (e) {
				if (N === void 0 || e.name !== "ErrnoError") throw e;
				return e.errno;
		...
		var hr = (e, t, n, r) => {
			for (var i = 0, a = 0; a < n; a++) {
				var o = b[t >> 2], s = b[t + 4 >> 2];
				t += 8;
				var c = N.read(e, g, o, s, r);
				if (c < 0) return -1;
				if (i += c, c < s) break;
				r !== void 0 && (r += c);
			}
		...
		function gr(e, t, n, r) {
			try {
				var i = hr(P.getStreamFromFD(e), t, n);
				return b[r >> 2] = i, 0;
			} catch (e) {
				if (N === void 0 || e.name !== "ErrnoError") throw e;
				return e.errno;
		...
		var _r = (e, t) => t + 2097152 >>> 0 < 4194305 - !!e ? (e >>> 0) + t * 4294967296 : NaN;
		function vr(e, t, n, r, i) {
			var a = _r(t, n);
			try {
				if (isNaN(a)) return 61;
				var o = P.getStreamFromFD(e);
				return N.llseek(o, a, r), w = [o.position >>> 0, (C = o.position, +Math.abs(C) >= 1 ? C > 0 ? Math.floor(C / 4294967296) >>> 0 : ~~+Math.ceil((C - +(~~C >>> 0)) / 4294967296) >>> 0 : 0)], y[i >> 2] = w[0], y[i + 4 >> 2] = w[1], o.getdents && a === 0 && r === 0 && (o.getdents = null), 0;
			} catch (e) {
				if (N === void 0 || e.name !== "ErrnoError") throw e;
				return e.errno;
			}
		...
		function br(e, t, n, r) {
			try {
				var i = yr(P.getStreamFromFD(e), t, n);
				return b[r >> 2] = i, 0;
			} catch (e) {
				if (N === void 0 || e.name !== "ErrnoError") throw e;
				return e.errno;
		...
		N.createPreloadedFile = nt, N.staticInit(), pt = r.InternalError = class extends Error {
			constructor(e) {
				super(e), this.name = "InternalError";
			}
		}, yt(), B = r.BindingError = class extends Error {
			constructor(e) {
				super(e), this.name = "BindingError";
			}
		}, Bt(), Ft(), $t(), cn = r.UnboundTypeError = sn(Error, "UnboundTypeError"), Cn();
		var xr = {
			p: Ve,
			j: ot,
			B: st,
			...
			t: Mr,
			f: jr
		}, Z = Pe(), Sr = () => (Sr = Z.U)(), Cr = (e) => (Cr = Z.V)(e), Q = (e) => (Q = Z.W)(e), wr = (e) => (wr = Z.Y)(e), $ = (e, t) => ($ = Z.Z)(e, t), Tr = (e) => (Tr = Z._)(e), Er = () => (Er = Z.$)(), Dr = (e) => (Dr = Z.aa)(e), Or = r.dynCall_jiji = (e, t, n, i, a) => (Or = r.dynCall_jiji = Z.ba)(e, t, n, i, a);
		function kr(e, t) {
			var n = E();
			try {
				return J(e)(t);
			} catch (e) {
				if (T(n), e !== e + 0) throw e;
				$(1, 0);
			}
		}
		function Ar(e, t) {
		...
		function Lr() {
			if (x > 0 || (me(), x > 0)) return;
			function e() {
				Ir || (Ir = !0, r.calledRun = !0, !oe && (he(), i(r), r.onRuntimeInitialized && r.onRuntimeInitialized(), ge()));
			}
	...
	static async fetchRemoteDataBlob(t) {
		return typeof t == "string" && t.indexOf("\n") !== -1 ? e.string2Uint8Data(t) : e.fetchRemoteData(t);
	}
	static async fetchRemoteData(e) {
		let t = await fetch(e);
		if (!t.ok) throw Error(`Failed to fetch ${e}: ${t.status} ${t.statusText}`);
		let n = await t.arrayBuffer();
		return new Uint8Array(n);
	}
	static string2Uint8Data(e) {
		let t = new Uint8Array(e.length);
		for (let n = 0; n < t.length; n++) t[n] = e.charCodeAt(n) & 255;
		return t;
	}
	...
	async initialize() {
		let t = await e();
		this.instance = t, this._decorate();
		let n = typeof window < "u" ? window : global;
		return n.arfset = this, this._setup(), this._createCanvas(), this;
	}
	_decorate() {
		["setup", "FS"].forEach((e) => {
			this[e] = this.instance[e];
		});
	}
	_createCanvas() {
		typeof document < "u" && (document.getElementById("iSet") && document.getElementById("iSet").remove(), this.canvas = document.createElement("canvas"), this.canvas.id = "iSet", this.ctx = this.canvas.getContext("2d"), this.canvasParent ? this.canvasParent.appendChild(this.canvas) : document.body.appendChild(this.canvas), console.log("canvas created"));
	}
	attachCanvas(e) {
		this.canvasParent = document.getElementById(e);
	}
	display() {
		var e = this;
		document.addEventListener("nftMarker", function(t) {
			e.canvas.width = t.detail.widthNFT, e.canvas.height = t.detail.heightNFT, e.numIset = t.detail.numIset, e.imageSetWidth = t.detail.widthNFT, e.imageSetHeight = t.detail.heightNFT, e.numFpoints = t.detail.numFpoints, e.dpi = t.detail.dpi;
			let n = new Uint8Array(e.instance.HEAPU8.buffer, e.frameIbwpointer, e.frameimgBWsize), r = new ImageData(e.canvas.width, e.canvas.height), i = new Uint32Array(r.data.buffer);
			for (let e = 0; e < n.length; e++) {
				let t = n[e];
				i[e] = 4278190080 | t << 16 | t << 8 | t;
			}
			e.ctx.putImageData(r, 0, 0), e._drawPoints(t.detail.nftPoints, 10, "#34FF19", 2), e._drawPoints(t.detail.nftFsetPoints, 4, "#FF0119", 1);
			var a = new Event("imageEv");
			document.dispatchEvent(a);
		});
	}
	_drawPoints(e, t, n, r) {
		if (!e) return;
		this.ctx.strokeStyle = n, this.ctx.lineWidth = r;
		let i = e.size();
		for (let n = 0; n < i; n++) {
			let r = e.get(n);
			this.ctx.beginPath(), this.ctx.arc(r[0], r[1], t, 0, 2 * Math.PI, !1), this.ctx.stroke();
		}
		e.delete();
	}
	async loadNFTMarker(e) {
		return await this.addNFTMarker(this.id, e).then((e) => {
			this.frameIbwpointer = e.pointer, this.frameimgBWsize = e.imgBWsize;
			var t = new CustomEvent("nftMarker", { detail: {
				numIset: e.numIset,
				widthNFT: e.width,
				heightNFT: e.height,
				dpi: e.dpi,
				numFpoints: e.numFpoints,
				pointerFeaturePoints: e.nftFeaturePoints,
				nftPoints: e.nftPoints,
				nftFsetPoints: e.nftFsetPoints
			} });
			document.dispatchEvent(t);
		});
	}
	async loadNFTMarkerBlob(e) {
		return await this.addNFTMarkerBlob(this.id, e).then((e) => {
			this.frameIbwpointer = e.pointer, this.frameimgBWsize = e.imgBWsize;
			var t = new CustomEvent("nftMarker", { detail: {
				numIset: e.numIset,
				widthNFT: e.width,
	...
	async addNFTMarker(e, n) {
		let r = "/markerNFT_" + this.nftMarkerCount++, i = [
			"fset",
			"iset",
			"fset3"
		].map(async function(e) {
			let i = n + "." + e, a = r + "." + e, o = await t.fetchRemoteData(i);
			this._storeDataFile(o, a);
		}, this);
		return await Promise.all(i), this.instance._readNFTMarker(e, r);
	}
	async addNFTMarkerBlob(e, n) {
		let r = "/markerNFT_" + this.nftMarkerCount++, i = [
			"iset",
			"fset3",
			"fset"
		].map(async function(e, i) {
			let a = n[i], o = r + "." + e, s = await t.fetchRemoteDataBlob(a);
			this._storeDataFile(s, o);
		}, this);
		return await Promise.all(i), this.instance._readNFTMarker(e, r);
	}
	_storeDataFile(e, t) {
		this.instance.FS.writeFile(t, e, { encoding: "binary" });
	}
	_setup() {
